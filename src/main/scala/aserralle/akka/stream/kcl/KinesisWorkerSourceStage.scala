...
class KinesisWorkerSourceStage(
  ...
  private val out: Outlet[CommittableRecord] = Outlet(
    "KinesisWorkerSourceStage.out")
  ...
  override def createLogic(inheritedAttributes: Attributes): GraphStageLogic =
    new TimerGraphStageLogic(shape) with StageLogging {
      ...
      override def preStart(): Unit = {
        ...
        log.info(s"Created Worker instance {} of application {}",
                 worker,
      ...
      override def postStop(): Unit = {
        ...
        log.info(s"Shut down Worker instance {} of application {}",
                 worker,
                 worker.getApplicationName)
      }
